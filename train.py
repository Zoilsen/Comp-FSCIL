...
def get_command_line_parser():
    ...
    parser.add_argument('-not_data_init_novel', action='store_true', help='using average data embedding to init or not')
    ...
    parser.add_argument('-new_mode', type=str, default='avg_cos',
                        choices=['ft_dot', 'ft_cos', 'avg_cos', 'avg_dot']) # ft_dot means using linear classifier, ft_cos means using cosine classifier, avg_cos means using average data embedding and cosine classifier
    ...
    parser.add_argument('-pretrain_encoder_dir', type=str, default=None, help='')
    ...
    parser.add_argument('-evaluation', action='store_true', help='if true, all training will be disabled')
    ...
    parser.add_argument('-aux_param', default=1.0, type=float)

    parser.add_argument('-begin_epoch', default=0, type=int)

    parser.add_argument('-primitive_recon_cls_weight', default=0.0, type=float)
    parser.add_argument('-ft_primitive_recon_weight', default=0.0, type=float)
    parser.add_argument('-ft_prim_recon_tau', default=16.0, type=float)

    parser.add_argument('-map_metric_option', default='none', type=str, choices=['none', 'cka'])
    parser.add_argument('-map_metric_cls_w', default=0.0, type=float)
    parser.add_argument('-map_pow', default=1.0, type=float)
    parser.add_argument('-bkb_feat_pow', default=1.0, type=float)
